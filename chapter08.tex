...
By a \emph{chain} of prime ideals of a ring $A$ we mean a finite strictly increasing sequence $\mathfrak{p}_0 \subset \mathfrak{p}_1 \subset \cdots \subset \mathfrak{p}_n$; the \emph{length}\index{Length} of the chain is $n$. We define the \emph{dimension}\index{Dimension} of $A$ to be the supremum of the lengths of all chains of prime ideals in $A$: it is an integer $\geq 0$, or $+\infty$ (assuming $A \neq 0$). A field has dimension 0; the ring $\Z$ has dimension 1.
