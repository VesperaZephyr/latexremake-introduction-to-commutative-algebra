...
\begin{proposition}\label{pro:universal property of ring of fractions}
...
\begin{proof}
By \eqref{pro:universal property of ring of fractions} we have to show that $h \colon S^{-1}A \to B$, defined by
\[
    h(a/s) = g(a)g(s)^{-1}
\]
...
\[
    (a/s, m) \mapsto am/s
\]
is $A$-bilinear, and therefore by the universal property \eqref{prop:tensor-universal} of the tensor product induces an $A$-homomorphism
\[
...
(iii) $\implies$ (i). Let $M' = \Ker(\phi)$, then the sequence $0 \longrightarrow M' \longrightarrow M \longrightarrow N$ is exact, hence $0 \longrightarrow M'_{\mathfrak{m}} \longrightarrow M_{\mathfrak{m}} \longrightarrow N_{\mathfrak{m}}$ is exact by \eqref{prop:localization-exact} and therefore $M'_{\mathfrak{m}} \cong \Ker(\phi_{\mathfrak{m}}) = 0$ since $\phi_{\mathfrak{m}}$ is injective. Hence $M' = 0$ by \eqref{prop:zero-local}, hence $\phi$ is injective.
...
\subsec{Extended and Contracted Ideals in Rings of Fractions}
