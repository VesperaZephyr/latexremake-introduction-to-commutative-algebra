...
The nilradical of $A$ is the intersection of(Ideal(s)!intersection of) all the prime ideals of $A$.
\end{proposition}
...
The \emph{intersection}\index{Ideal(s)!intersection} of any family $(\mathfrak{a}_i)_{i \in I}$ of ideals is an ideal. Thus the ideals of $A$ form a complete lattice with respect to inclusion.
